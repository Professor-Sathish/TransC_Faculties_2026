...
<body>
    <div class="container">
        <div style="text-align: center;">
            <h1>🏦 V6 Bank Account Manager</h1>
            <span class="version-badge">✨ V6 Enhanced - Advanced Sorting</span>
        </div>

        <div class="feature-highlight">
            <strong>🚀 V6 New Features:</strong> Sort by Balance/Name (Asc/Desc) • Find Max/Min Balance • Data Validation • Corruption Filtering
        </div>
        ...
        <div class="footer-credits" style="text-align: center; margin-top: 30px; color: #666;">
            <h4>V6 Enhanced by Your Development Team • Original UI Template Credits</h4>
            <p style="font-size: 0.9rem; margin-top: 10px;">🚀 Now with Advanced Sorting, Data Validation & Corruption Filtering</p>
        </div>
    </div>
